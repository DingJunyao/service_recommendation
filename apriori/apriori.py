...
def recommend_apriori(s_rate, rate_time, association_rules, uid, num=10,
                      time_limit=0.2):
    """
...
if __name__ == '__main__':
    ...
    recommend_list_example = recommend_apriori(s_rate_old, rate_time_old, ar, 5)
    ...
    for u in s_rate_old.columns:
        ...
        recommend_list_with_score = recommend_apriori(s_rate_old, rate_time_old, ar, u)
